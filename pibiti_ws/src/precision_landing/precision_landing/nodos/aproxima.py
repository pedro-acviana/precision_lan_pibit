...
class aproxima(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        ...
        try:
            ...
            # Normaliza e escala as velocidades
            ...
            smoothed_velocity = self.smooth_velocity([velocity_x, velocity_y, 0.0])
            velocity_x, velocity_y = smoothed_velocity[0], smoothed_velocity[1]

            # Verifica se chegou perto o suficiente para iniciar pouso
            if distance_horizontal < self.tolerance:
                ...
                velocity_x = 0.0
                velocity_y = 0.0
                velocity_z = self.landing_velocity
